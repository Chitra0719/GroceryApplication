...
public class WaitUtility {
	...
	public void waitUntilElementAlertisPresent(WebDriver driver, WebElement element) {

		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(EXPLICITWAIT));
		wait.until(ExpectedConditions.alertIsPresent());
	}
	public void waitUntildomAttributeToBe(WebDriver driver, WebElement element) {

		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(EXPLICITWAIT));
		wait.until(ExpectedConditions.domAttributeToBe(element, null, null));
	}
	public void waitUntiltextToBePresentInElementLocated(WebDriver driver, WebElement element) {
